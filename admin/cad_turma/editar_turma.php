...
$id = intval($_GET['id']); // Certifique-se de que $id é um número inteiro
    ...
    $result = $db->query("SELECT * FROM cad_turma WHERE id='$id'");
...
<div class="row">
        <div class="">	
            <div class="form-group">
                <label for="Nome">Nome da Turma/Setor </label>
                <input type="text" style="border: 1px solid #C0C0C0;" value="<?php echo $nome ?>" required class="form-control" name="turma" id="turma" placeholder="Descrição">
...
<script>
    $(document).ready(function() {
        ...
        $('#cadastroForm').on('submit', function(e) {
            ...
            $.ajax({
                url: 'cad_turma/salva_editar_turma.php',
                type: 'POST',
                data: formData,
