...
<div id="categorias">
<h3>Inserir Novo Formato de Acervo</h3><hr>
...
<div class="row">
        <div class="col-lg-8">	
            <div class="form-group">
                <label for="Nome">Nome do Formato </label>
                <input type="text" style="border: 1px solid #C0C0C0;" required class="form-control" name="descricao" id="descricao" placeholder="Descrição">
...
<div class="container tabela-areas">
        <h2 class="my-4">Lista de Formatos Cadastrados</h2>
    ...
    $(document).ready(function() {
        ...
        $('#cadastroForm').on('submit', function(e) {
            ...
            var descricao = $('#descricao').val();
                ...
                $.ajax({
                    type: 'POST',
                    url: 'cad_acervos/tipo/salva_tipo.php',
                    data: { 
                        descricao: descricao
        ...
        $('.edit-btn').on('click', function() {
                ...
                $('#categorias').load("cad_acervos/tipo/editar_formato.php?id="+id)
            ...
            $('.delete-btn').on('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: 'POST',
                            url: 'cad_acervos/tipo/delete_formato.php',
                            data: { id: id },
                            success: function(response) {
