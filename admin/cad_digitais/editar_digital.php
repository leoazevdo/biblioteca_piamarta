...
$query = "SELECT * FROM cad_acervo_digital WHERE id = ?";
...
$arquivoCaminho = $row['arquivo_caminho'];
        ...
        <div class="col-lg-4">    
            <div class="text-center">
                <div class="editor2 mb-2">
                    ...
                    <div id="foto">
                        <img src="../uploads/imagens/<?php echo htmlspecialchars($imagemCaminho) ?>" alt="Book Cover">
                    </div>  
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12"> 
                    <div class="form-group"> 
                        ...
                        <input type="text" style="border: 1px solid #C0C0C0;" class="form-control" id="titulo" name="titulo" placeholder="Título" value="<?php echo htmlspecialchars($titulo) ?>">
                        ...
                        <?php if ($arquivoCaminho): ?>
                            <small>Arquivo atual: <a href="../uploads/arquivos/<?php echo htmlspecialchars($arquivoCaminho) ?>" target="_blank">Visualizar</a></small>
                        <?php endif; ?>
                    </div>              
                </div>
                <div class="col-lg-12">    
                    <div class="form-group">
                        ...
                        <input type="text" style="border: 1px solid #C0C0C0;" class="form-control" name="autor" id="autor" placeholder="Autor" value="<?php echo htmlspecialchars($autor) ?>">
                    </div>
                </div>
                <div class="col-lg-6">    
                    <div class="form-group">
                        <label for="Editora">Editora</label>
                        <input type="text" style="border: 1px solid #C0C0C0;" class="form-control" name="editora" id="editora" placeholder="Editora" value="<?php echo htmlspecialchars($editora) ?>">
                    </div>
                </div>
                <div class="col-lg-2">    
                    <div class="form-group">
                        <label for="Editora">Ano</label>
                        <input type="text" style="border: 1px solid #C0C0C0;" class="form-control" name="ano" id="ano" placeholder="Ano" value="<?php echo htmlspecialchars($ano) ?>">
                    </div>
                </div>
                <div class="col-lg-4">    
                    <div class="form-group">
                        <label for="Nome">Área de Conhecimento</label>
                        <select class="form-control" id="categoria" name="categoria" required style="border: 1px solid #C0C0C0;">
                            <option value="">Selecione...</option>
                            <?php
                            // Consulta todos os registros da tabela cad_categoria
                            $result = $db->query("SELECT * FROM cad_categoria ORDER BY titulo");
                            while ($rowCategoria = $result->fetchArray(SQLITE3_ASSOC)) {
                                $selected = ($rowCategoria['id'] == $categoria) ? 'selected' : '';
                                echo '<option value="' . htmlspecialchars($rowCategoria['id']) . '" ' . $selected . '>' . htmlspecialchars($rowCategoria['titulo']) . '</option>';
                            }
                            ?>
                        </select>                        
                    </div>
                ...
                <div class="col-lg-12">    
                    <div class="form-group">
                        ...
                        <textarea class="form-control texto" style="border: 1px solid #C0C0C0;" name="sinopse" id="sinopse" rows="6"><?php echo htmlspecialchars($sinopse) ?></textarea>                       
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
...
<script>
    $(function(){
        ...
        function enviarFormulario(base64Image) {
            ...
            $.ajax({
                url: 'cad_digitais/salva_editar_digital.php', // URL do arquivo PHP que processará os dados
                method: 'POST',
                data: formData,
