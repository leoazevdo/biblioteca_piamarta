        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <button class="btn btn-primary abrir_top">Top Leitores</button>
                    </div>
                </div>
                <div id="tabela"></div>
            </div>
...
<script>
    ...
    // 🚀 Novo botão: Top Leitores
        $('.abrir_top').click(function () {
            var ano = $("#ano").val();
            var mes = $('#mes').val();
            ...
            if (!ano) {
                ...
                $("#tabela").load("cad_relatorio/rel_top_leitores.php?ano=" + ano + "&mes=" + mes);
            }
        });
    });
